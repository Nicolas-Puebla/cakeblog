...
class NoticiasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'link' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-11-01 23:40:30',
                'modified' => '2018-11-01 23:40:30'
            ],
        ];
        parent::init();
    }
