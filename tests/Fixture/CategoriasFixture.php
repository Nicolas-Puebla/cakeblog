...
class CategoriasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'descripcion' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-11-02 00:07:33',
                'modified' => '2018-11-02 00:07:33'
            ],
        ];
        parent::init();
    }
